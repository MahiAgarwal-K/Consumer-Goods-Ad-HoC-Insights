...
2. Provide an aggregated monthly gross sales report for Croma India.

3. Create a stored procedure for monthly gross sales report

4. Create a stored procedure to determine the market badge. If the total sold quantity is greater     than 5 million, the market should be considered Gold; otherwise, it should be considered Silver.

5. Identify the top market, top selling products, top customers based on net sales.

6. Create a stored procedure to return the top N markets, customers, products based on net sales.

7. Provide a bar chart report for the top 10 customers based on percentage net sales for the financial year 2021.
